...
export function Home() {
  return (
    <main className="home">
      ...
      {/* Two doors side by side, because neither game is the default one. Links
          rather than controls, so a player can bookmark the game they play. */}
...
export function GettingStarted() {
  return (
    <main className="home">
      ...
      <p>
        <a className="home__back" href="#/">
          Back to Hades Handbook
        </a>
      </p>
    </main>
  );
